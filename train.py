...
def predict_test(show_confusion_matrix=False):
    ...
    _loss, batch_acc = sess.run([loss, accuracy], feed_dict={x: test_x, y: test_y})
    acc_percent = batch_acc*100
    msg = "Test Accuracy: {0:.2f}%, Test Loss = {1:.2f}"
    print(msg.format(acc_percent, _loss))
